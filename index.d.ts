declare namespace ThinkSequelize {
  ...
  interface SequelizeModel {
    ...
    belongsTo(model: SequelizeModel):IncludeAssociation;
    hasOne(model: SequelizeModel, opts?: any):IncludeAssociation;
    hasMany(model: SequelizeModel, opts?: any):IncludeAssociation;
    update(...args: any[]): SequelizeEmitters;
  }
...
declare module 'thinkjs' {
  ...
  interface Controller extends ThinkSequelize.ModelExtend, ThinkSequelize.ModelThinkExtend {
  }
  interface Context extends ThinkSequelize.ModelExtend, ThinkSequelize.ModelThinkExtend {
  }
  interface Service extends ThinkSequelize.ModelExtend, ThinkSequelize.ModelThinkExtend {
  }
}
